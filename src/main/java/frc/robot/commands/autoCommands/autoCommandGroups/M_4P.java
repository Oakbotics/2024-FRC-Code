  ...
  public M_4P(DriveSubsystem driveSubsystem, ShooterSubsystem shooterSubsystem, ConveyorSubsystem conveyorSubsystem, PnuematicSubsystem pnuematicSubsystem) {
    ...
    addCommands(
      new SequentialCommandGroup(
        ...
        new ParallelCommandGroup(
          new SensorIntakeCommand(m_conveyorSubsystem, m_shooterSubsystem, true).withTimeout(3),
          new GoToAutoPositionCommand(m_driveSubsystem, ()-> new Pose2d(AutoConstants.bC1Pose.getTranslation(), Rotation2d.fromDegrees(45)))
        ),
        new GoToAutoPositionCommand(m_driveSubsystem,()->  AutoConstants.middleStartingPose),
        new RevThenShootCommandGroup(m_conveyorSubsystem, m_shooterSubsystem),
        new ParallelCommandGroup(
          new SensorIntakeCommand(m_conveyorSubsystem, m_shooterSubsystem, true).withTimeout(3),
          new GoToAutoPositionCommand(m_driveSubsystem,()->  new Pose2d(AutoConstants.bC3Pose.getTranslation(), Rotation2d.fromDegrees(-45)))
        ),
        new GoToAutoPositionCommand(m_driveSubsystem,()->  AutoConstants.middleStartingPose),
        new RevThenShootCommandGroup(m_conveyorSubsystem, m_shooterSubsystem)
      )
