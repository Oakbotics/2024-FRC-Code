...
public class B_2PRedTesting extends SequentialCommandGroup {
   ...
   */
  public B_2PRedTesting(DriveSubsystem driveSubsystem, ShooterSubsystem shooterSubsystem, ConveyorSubsystem conveyorSubsystem, PnuematicSubsystem pnuematicSubsystem) {
    ...
    addCommands(
      new SequentialCommandGroup(
        ...
        new InstantCommand(()-> m_driveSubsystem.resetBotPose(GeometryUtil.flipFieldPose(AutoConstants.bottomStartingPose))),
        ...
        new ParallelCommandGroup(
         // new SensorIntakeCommand(m_conveyorSubsystem, m_shooterSubsystem, true).withTimeout(5),
          new GoToAutoPositionCommand(m_driveSubsystem, ()-> GeometryUtil.flipFieldPose(AutoConstants.bC3Pose)).withTimeout(5)
        ),
        ...
        new GoToAutoPositionCommand(m_driveSubsystem, ()-> GeometryUtil.flipFieldPose(AutoConstants.bottomStartingPose)).withTimeout((2)),
