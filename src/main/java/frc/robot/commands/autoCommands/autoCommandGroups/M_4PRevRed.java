...
public class M_4PRevRed extends SequentialCommandGroup {
   ...
   */
  public M_4PRevRed(DriveSubsystem driveSubsystem, ShooterSubsystem shooterSubsystem, ConveyorSubsystem conveyorSubsystem, PnuematicSubsystem pnuematicSubsystem) {
    ...
    addCommands(
      new SequentialCommandGroup(
        ...
        new GoToAutoPositionCommand(m_driveSubsystem, ()-> AutoConstants.bC3LineupPose),

        new ParallelCommandGroup(
          new SensorIntakeCommand(m_conveyorSubsystem, m_shooterSubsystem, true).withTimeout(3),
          new GoToAutoPositionCommand(m_driveSubsystem, ()-> new Pose2d(AutoConstants.bC3Pose.getTranslation(), Rotation2d.fromDegrees(0))).withTimeout(2.5)
        ),
        ...
        new GoToAutoPositionCommand(m_driveSubsystem, ()-> AutoConstants.bC1LineupPose).alongWith(new SensorIntakeCommand(m_conveyorSubsystem, m_shooterSubsystem, false).withTimeout(1)),
        new ParallelCommandGroup(
          new SensorIntakeCommand(m_conveyorSubsystem, m_shooterSubsystem, true).withTimeout(3),
